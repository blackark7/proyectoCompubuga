      ...
      <div id="content">
        ...
        <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Crear Materia</h6>
                </div>
                <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="area">
                ...
                <option value="asistenteAdmin">Asistente administrativo</option>
                <option value="logistica">losgistica</option>
              </select>
            </div>
