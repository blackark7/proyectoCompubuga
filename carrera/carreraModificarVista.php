...
$result = $carrerasModelo->mostrar($id);
                    ...
                    <div class="container">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Modificar Carrera</h6>
                            </div>
                            <div class="card-body">
                                <form action="carreraModificarControlador.php" method="post" >
                                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                                    <div class="form-group">
                                        <label for="">Carrera</label>
                                        <input type="text" value="<?php echo $nombre; ?>" class="form-control" name="carrera" required="">
